...
"username" id="username" type=
"text" 
 
placeholder=
"Username 입력" required autofocus>
...
<script src=
"${contextPath}/resources/vendor/bootstrap/js/bootstrap.min.js"></script>
 
<!-- Metis Menu Plugin JavaScript -->
 
<script src=
"${contextPath}/resources/vendor/metisMenu/metisMenu.min.js"></script>
